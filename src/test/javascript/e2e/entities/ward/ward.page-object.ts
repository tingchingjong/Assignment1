...
export class WardComponentsPage {
  ...
  deleteButtons = element.all(by.css('ic-ward div table .btn-danger'));
  title = element.all(by.css('ic-ward div h2#page-heading span')).first();
...
export class WardUpdatePage {
  pageTitle = element(by.id('ic-ward-heading'));
...
export class WardDeleteDialog {
  private dialogTitle = element(by.id('ic-delete-ward-heading'));
  private confirmButton = element(by.id('ic-confirm-delete-ward'));
