...
export class BedComponentsPage {
  ...
  deleteButtons = element.all(by.css('ic-bed div table .btn-danger'));
  title = element.all(by.css('ic-bed div h2#page-heading span')).first();
...
export class BedUpdatePage {
  pageTitle = element(by.id('ic-bed-heading'));
...
export class BedDeleteDialog {
  private dialogTitle = element(by.id('ic-delete-bed-heading'));
  private confirmButton = element(by.id('ic-confirm-delete-bed'));
